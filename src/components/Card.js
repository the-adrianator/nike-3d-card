  ...
  return ( 
    ...
    <div style={{ perspective: 2000 }}>
      ...
      <motion.div 
        ...
        {/* card subtitle */}
        <p className='max-w-[300px] text-[#000000] mb-6'>Taking the classic look of heritage Nike Running into new realms, the Nike Air Max Pre-Day brings you a fast-paced look that's ready for today's world.</p>
        {/* btn & price wrapper */}
